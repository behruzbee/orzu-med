...
import { Box, Card, Flex, LoadingOverlay, Pagination, Title } from '@mantine/core'
        ...
        return (
                <>
                        <Flex justify="space-between" align="center" mb="md" >
                                {/* @ts-ignore */}
                                {currentTable && <Title order={2}>Отчет по неделы  {new Date(currentTable.data?.date).toLocaleDateString('ru-RU', {
                                        month: '2-digit',
                                        year: 'numeric'
                                })}</Title>}
                        </Flex>
